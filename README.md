...
The implementation is broken into two parts as follows
...
I adapted the program from part 1 to add a timer. The default time limit should be 30 second, but teh time is customizable via a flag
